...
def run_llm(QUERY:str, SUBJECT:str, CHAT_HISTORY: list((str, any))=[])->any:
    ...
    #Ingest docuements
    PATH = r"E:\Langchain Tutorial\local-vector-store\current_affairs_iasbaba.pdf" if SUBJECT == 'Current_affairs' else r'C:\Users\LENOVO\Downloads\bill_passed.pdf'
    ...
    qa = ConversationalRetrievalChain.from_llm(llm=llm, retriever=vector_store.as_retriever(), return_source_documents=True)   
